...
Blockly.Msg["ENVVAR_ATTRIB_HELPURL"] = "http://velocity.apache.org/engine/1.7/vtl-reference.html#properties";  // untranslated
Blockly.Msg["ENVVAR_ATTRIB_TOOLTIP"] = "Attributes of XWiki Script Object";  // untranslated
Blockly.Msg["ENVVAR_CONSTANT_HELPURL"] = "https://www.xwiki.org/xwiki/bin/view/Documentation/DevGuide/Scripting/APIGuide/";  // untranslated
Blockly.Msg["ENVVAR_CONSTANT_TOOLTIP"] = "Return XWiki script variables";  // untranslated
Blockly.Msg["ENVVAR_METHOD_CREATEWITH"] = "Arguments";  // untranslated
Blockly.Msg["ENVVAR_METHOD_CREATE_ARGS_TITLE"] = "Add arguments";  // untranslated
Blockly.Msg["ENVVAR_METHOD_CREATE_ARGS_TOOLTIP"] = "Add or remove arguments as needed for your method call";  // untranslated
Blockly.Msg["ENVVAR_METHOD_CREATE_ARG_TITLE"] = "Argument";  // untranslated
Blockly.Msg["ENVVAR_METHOD_CREATE_ARG_TOOLTIP"] = "Add an argument to the function.";  // untranslated
Blockly.Msg["ENVVAR_METHOD_HELPURL"] = "http://velocity.apache.org/engine/1.7/vtl-reference.html#methods";  // untranslated
Blockly.Msg["ENVVAR_METHOD_TOOLTIP"] = "Methods of XWiki Script Object";  // untranslated
Blockly.Msg["ENVVAR_TEXT_HELPURL"] = "https://en.wikipedia.org/wiki/String_(computer_science)";  // untranslated
Blockly.Msg["ENVVAR_TEXT_TOOLTIP"] = "An input field for method/attribute name";  // untranslated
...
Blockly.Msg["QUERIES_ANDOR_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.3/reference/en/html/queryhql.html#queryhql-expressions";  // untranslated
Blockly.Msg["QUERIES_ANDOR_TOOLTIP"] = "This block returns the boolean AND/OR of the two expressions";  // untranslated
Blockly.Msg["QUERIES_ARGS_CONTAINER_TOOLTIP"] = "Add, remove, or reorder sections to reconfigure this text block.";  // untranslated
Blockly.Msg["QUERIES_ARGS_CREATEWITH"] = "Arguments";  // untranslated
Blockly.Msg["QUERIES_ARGS_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.5/reference/en/html/queryhql.html";  // untranslated
Blockly.Msg["QUERIES_ARGS_ITEM_TITLE"] = "Item";  // untranslated
Blockly.Msg["QUERIES_ARGS_ITEM_TOOLTIP"] = "Adds an argument to the args list.";  // untranslated
Blockly.Msg["QUERIES_ARGS_TITLE"] = "Add arguments";  // untranslated
Blockly.Msg["QUERIES_ARGS_TOOLTIP"] = "The list of arguments to be supplied to the select/from statement";  // untranslated
Blockly.Msg["QUERIES_AS_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.3/reference/en/html/queryhql.html#queryhql-from";  // untranslated
Blockly.Msg["QUERIES_AS_TOOLTIP"] = "This keyword assigns an alias so that it can be used later in the query";  // untranslated
Blockly.Msg["QUERIES_COMPARISON_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.3/reference/en/html/queryhql.html#queryhql-expressions";  // untranslated
Blockly.Msg["QUERIES_COMPARISON_TOOLTIP"] = "Used for comparison of two expressions";  // untranslated
Blockly.Msg["QUERIES_DISTINCT_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.5/reference/en/html/queryhql.html#queryhql-select";  // untranslated
Blockly.Msg["QUERIES_DISTINCT_TOOLTIP"] = "The distinct statement is used to return only distinct (different) values.";  // untranslated
Blockly.Msg["QUERIES_EXECUTE_HELPURL"] = "https://extensions.xwiki.org/xwiki/bin/view/Extension/Query%20Module#HFromVelocity";  // untranslated
Blockly.Msg["QUERIES_EXECUTE_TOOLTIP"] = "A block to execute the query after constructing it";  // untranslated
Blockly.Msg["QUERIES_LIKE_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.3/reference/en/html/queryhql.html#queryhql-joins-forms";  // untranslated
Blockly.Msg["QUERIES_LIKE_TOOLTIP"] = "The LIKE operator is used in a WHERE clause to search for a specified pattern";  // untranslated
Blockly.Msg["QUERIES_MAIN_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.3/reference/en/html/queryhql.html";  // untranslated
Blockly.Msg["QUERIES_MAIN_TOOLTIP"] = "Used to construct the query. Contains SELECT, FROM and WHERE clauses";  // untranslated
Blockly.Msg["QUERIES_NOT_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.3/reference/en/html/queryhql.html#queryhql-expressions";  // untranslated
Blockly.Msg["QUERIES_NOT_TOOLTIP"] = "This operator returns the boolean compliment of the expression.";  // untranslated
Blockly.Msg["QUERIES_OBJECT_HELPURL"] = "http://velocity.apache.org/engine/1.7/vtl-reference.html#properties";  // untranslated
Blockly.Msg["QUERIES_OBJECT_TOOLTIP"] = "To access objects and their attributes in XWQL";  // untranslated
Blockly.Msg["QUERIES_ORDER_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.3/reference/en/html/queryhql.html#queryhql-ordering";  // untranslated
Blockly.Msg["QUERIES_ORDER_TOOLTIP"] = "The list returned by a query can be ordered by any property of a returned class or components";  // untranslated
Blockly.Msg["QUERIES_XOBJECT_HELPURL"] = "https://extensions.xwiki.org/xwiki/bin/view/Extension/Query%20Module";  // untranslated
Blockly.Msg["QUERIES_XOBJECT_TOOLTIP"] = "Special syntax is used for XWiki objects in XWQL in from and where clauses:";  // untranslated
