...
Blockly.Msg["QUERIES_AS_HELPURL"] = "This keyword assigns an alias so that it can be used later in the query";  // untranslated
Blockly.Msg["QUERIES_AS_TOOLTIP"] = "https://docs.jboss.org/hibernate/orm/3.5/reference/en/html/queryhql.html#queryhql-from";  // untranslated
...
Blockly.Msg["QUERIES_FROM_ARGS_CONTAINER_TOOLTIP"] = "Add, remove, or reorder sections to reconfigure this text block.";  // untranslated
Blockly.Msg["QUERIES_FROM_ARGS_CREATEWITH"] = "From Clause Arguments";  // untranslated
Blockly.Msg["QUERIES_FROM_ARGS_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.5/reference/en/html/queryhql.html#queryhql-from";  // untranslated
Blockly.Msg["QUERIES_FROM_ARGS_ITEM_TITLE"] = "Item";  // untranslated
Blockly.Msg["QUERIES_FROM_ARGS_ITEM_TOOLTIP"] = "Add an object to the from statement.";  // untranslated
Blockly.Msg["QUERIES_FROM_ARGS_TITLE"] = "Add arguments";  // untranslated
Blockly.Msg["QUERIES_FROM_ARGS_TOOLTIP"] = "The from clause specifies which class to return from.";  // untranslated
...
Blockly.Msg["QUERIES_SELECT_ARGS_CONTAINER_TOOLTIP"] = "Add, remove, or reorder sections to reconfigure this text block.";  // untranslated
Blockly.Msg["QUERIES_SELECT_ARGS_CREATEWITH"] = "Select Clause Arguments";  // untranslated
Blockly.Msg["QUERIES_SELECT_ARGS_HELPURL"] = "https://docs.jboss.org/hibernate/orm/3.5/reference/en/html/queryhql.html#queryhql-select";  // untranslated
Blockly.Msg["QUERIES_SELECT_ARGS_ITEM_TITLE"] = "Item";  // untranslated
Blockly.Msg["QUERIES_SELECT_ARGS_ITEM_TOOLTIP"] = "Add an object to the select statement.";  // untranslated
Blockly.Msg["QUERIES_SELECT_ARGS_TITLE"] = "Add arguments";  // untranslated
Blockly.Msg["QUERIES_SELECT_ARGS_TOOLTIP"] = "The select clause picks which objects and properties to return in the query result set.";  // untranslated
