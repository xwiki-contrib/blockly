...
goog.provide('Blockly.Velocity.variables');

goog.require('Blockly.Velocity');


Blockly.Velocity['variables_get'] = function(block) {
  // Variable getter.
  var code = Blockly.Velocity.variableDB_.getName(block.getFieldValue('VAR'),
      Blockly.Variables.NAME_TYPE);
  return [code, Blockly.Velocity.ORDER_ATOMIC];
};

Blockly.Velocity['variables_set'] = function(block) {
  // Variable setter.
